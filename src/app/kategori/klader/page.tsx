...
export default function ClothingCategoryPage() {
  const [selectedCategory, setSelectedCategory] = useState<string>('Kläder');
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-lg p-8 mb-8 text-white">
              ...
              <p className="text-orange-100 text-lg mb-4">
                Designa t-shirts, hoodies, kepsar och andra klädesplagg med dina egna design. Hög kvalitet och snabb leverans.
              </p>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-1">
                Visar {startIndex + 1}-{Math.min(endIndex, filteredProducts.length)} av {filteredProducts.length} produkt{filteredProducts.length !== 1 ? 'er' : ''}
              </p>
            </div>
