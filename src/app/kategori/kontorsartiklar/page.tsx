...
export default function OfficeSuppliesPage() {
  const [selectedCategory, setSelectedCategory] = useState<string>('Kontorsartiklar');
  ...
  return (
    <PageLayout 
      title="Kontorsartiklar - Kategori" 
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-lg p-8 mb-8 text-white">
              ...
              <p className="text-orange-100 text-lg mb-4">
                Professionella kontorsartiklar med din egen design. Anteckningsböcker, pennor, kalendrar och mer.
              </p>
