...
export default function HomeDecorPage() {
  const [selectedCategory, setSelectedCategory] = useState<string>('Hem & Inredning');
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-lg p-8 mb-8 text-white">
              ...
              <p className="text-orange-100 text-lg mb-4">
                Personalisera ditt hem med unika canvas-tryck, kuddar, filtar och inredningsdetaljer.
              </p>
