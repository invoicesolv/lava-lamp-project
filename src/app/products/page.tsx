...
export default function ProductsPage() {
  ...
  return (
    <>
      <ProductListSchemaMarkup products={filteredProducts} />
      <PageLayout 
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-lg p-8 mb-8 text-white">
              <h1 className="text-3xl font-bold mb-4">
                {selectedCategory === 'all' ? 'Alla våra produkter' : categories.find(c => c.id === selectedCategory)?.name}
              </h1>
              <p className="text-orange-100 text-lg mb-4">
                Upptäck vårt breda sortiment av högkvalitativa produkter för tryck och broderi
              </p>
            ...
            {filteredProducts.length > 0 && (
              <div className="text-center mt-16 py-12 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Vi har många fler produkter tillgängliga. Kontakta oss så hjälper vi dig att hitta precis det du behöver.
                </p>
                <Link 
                  href="/contact"
