...
export const metadata: Metadata = {
  title: 'Tryck eget i Tungelsta - T-shirt med eget tryck | Tryckeget',
  description: 'Beställ tryckta kläder i Tungelsta! Vi levererar t-shirt med eget tryck, hoodie med eget tryck och keps med eget tryck direkt till din dörr. Snabb leverans inom 5-7 dagar till Tungelsta i Stockholmsregionen.',
  keywords: 'tryck eget tungelsta, t-shirt med eget tryck tungelsta, tryck på kläder tungelsta, anpassade kläder tungelsta, print on demand tungelsta, stockholm, stockholmsregionen',
  openGraph: {
    title: 'Tryck eget i Tungelsta - T-shirt med eget tryck | Tryckeget',
    description: 'Beställ tryckta kläder i Tungelsta! Vi levererar t-shirt med eget tryck, hoodie med eget tryck och keps med eget tryck direkt till din dörr. Snabb leverans inom 5-7 dagar till Tungelsta i Stockholmsregionen.',
    type: 'website',
...
export default function TungelstaPage() {
  return (
      ...
      <nav className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 py-3 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-medium">Tungelsta</span>
          </div>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center bg-orange-100 text-orange-800 px-4 py-2 rounded-full text-sm font-medium mb-6">
                🚚 Leverans till Tungelsta
              </div>
              
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Tryck eget i <span className="text-orange-500">Tungelsta</span> –<br />
                snabbt, enkelt och professionellt
              </h1>
              
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl">
                Behöver ni profilkläder till företaget i Tungelsta, tröjor till ett event eller en unik present? Hos Tryckeget kan du designa och beställa allt från en enda t-shirt till hundratals hoodies – vi levererar direkt till Tungelsta i Stockholmsregionen.
              </p>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-6 mb-8 text-sm text-gray-600">
                <div className="flex items-center bg-white px-4 py-2 rounded-lg shadow-sm">
                  ...
                  Leverans till Tungelsta inom 5-7 dagar
                </div>
                <div className="flex items-center bg-white px-4 py-2 rounded-lg shadow-sm">
                  <span className="text-green-500 mr-2">✓</span>
                  Inga minimiordrar
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Varför välja Tryckeget för tryck i Tungelsta?
              </h2>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Snabb leverans till Tungelsta</h3>
                    <p className="text-gray-600">Vi levererar dina tryckta kläder direkt till Tungelsta inom 5-7 dagar.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center mr-3 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Vi förstår behoven hos företag och privatpersoner i Tungelsta och Stockholmsregionen.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center mr-3 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Professionella tryckresultat som håller länge, perfekt för Tungelstas klimat och livsstil.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Populära produkter i Tungelsta</h3>
      ...
      <section className="py-16 bg-orange-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Redo att börja trycka i Tungelsta?
          </h2>
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Skapa dina egna tryckta kläder idag och få dem levererade till Tungelsta inom 5-7 dagar.
          </p>
          <Link 
            href="/design/upload?productId=unisex-jersey-tshirt&size=M&color=Vit&quantity=1"
