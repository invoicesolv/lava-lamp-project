...
// Read Malmö areas from the markdown file
const malmoAreasPath = path.join(__dirname, '../src/components/malmo.md');
const malmoAreas = fs.readFileSync(malmoAreasPath, 'utf8')
  .split('\n')
  .map(line => line.trim())
  .filter(line => line.length > 0);

// Create unique pages for Malmö areas
malmoAreas.forEach((area, index) => {
...
export const metadata: Metadata = {
  ...
  description: 'Beställ tryckta kläder i ${area}! Vi levererar t-shirt med eget tryck, hoodie med eget tryck och keps med eget tryck direkt till din dörr. Snabb leverans inom 5-7 dagar till ${area} i Skåne.',
  keywords: 'tryck eget ${area.toLowerCase()}, t-shirt med eget tryck ${area.toLowerCase()}, tryck på kläder ${area.toLowerCase()}, anpassade kläder ${area.toLowerCase()}, print on demand ${area.toLowerCase()}, malmö, skåne',
  openGraph: {
    title: 'Tryck eget i ${area} - T-shirt med eget tryck | Tryckeget',
    description: 'Beställ tryckta kläder i ${area}! Vi levererar t-shirt med eget tryck, hoodie med eget tryck och keps med eget tryck direkt till din dörr. Snabb leverans inom 5-7 dagar till ${area} i Skåne.',
    type: 'website',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl">
                Behöver ni profilkläder till företaget i ${area}, tröjor till ett event eller en unik present? Hos Tryckeget kan du designa och beställa allt från en enda t-shirt till hundratals hoodies – vi levererar direkt till ${area} i Skåne.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Vi förstår behoven hos företag och privatpersoner i ${area} och Skåne.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center mr-3 mt-1">
...
console.log(`\n🎉 Generated ${malmoAreas.length} unique Malmö area landing pages!`);
console.log(`📊 Malmö areas: ${malmoAreas.length}`);
console.log('\n📝 Next steps:');
